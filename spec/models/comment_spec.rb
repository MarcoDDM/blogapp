...
RSpec.describe Comment, type: :model do
  ...
  let(:post) { Post.create(author_id: tom.id, title: 'Title', text: 'Great post!', comments_counter: 0, likes_counter: 0) }

  it 'is valid with valid attributes' do
    comment = Comment.new(text: 'Great post!', author_id: tom.id, post: post)
